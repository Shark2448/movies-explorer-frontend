...
function SearchForm({ searchMovies, searchUserMovies, useFilterMovies, useFilterUserMovies }) {
  ...
  return (
    <section className="searchForm">
      <Route path="/movies">
        ...
        >
          <input
            ...
            placeholder="Фильм"
            defaultValue={valueSearchMovies || ""}
            required
          ></input>
          <button
            type="submit"
            className="searchForm__button page__link"
          ></button>
        </form>
        <div className="searchForm__case">
          <label
            ...
            defaultChecked={filteredMovie === "true" ? true : false}
          >
            <input
              type="checkbox"
      ...
      <Route path="/saved-movies">
        <form
          className="searchForm__form"
          onSubmit={handleSubmitUserMovies}
          onChange={handleChangeValues}
          noValidate
        >
          <input
        ...
        <div className="searchForm__case">
          <label className="searchForm__switch" onChange={useFilterUserMovies}>
            <input
              type="checkbox"
              className="searchForm__checkbox searchForm__checkbox-input"
            ></input>
